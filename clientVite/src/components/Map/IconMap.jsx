...
const IconMap = () => {
  ...
  useEffect(() => {
    ...
    mapSvg.pan({ x: 50, y: 50 });
    mapSvg.zoom(zoom);
    mapSvg.resize(); // update SVG cached size and controls positions
  ...
  return (
    <div className="m-auto mb-8">
      <h1 className="border-4 border-gray-950 w-fit m-auto rounded-xl h-20 mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
        {country}
      </h1>
      <div
        className="flex flex-col w-8/12 border-4 m-auto border-gray-950 mb-8"
      ...
      >
        ...
        ></path> */}
          ...
          onClick={(event) => redirect(event)}
        ></path> */}
          <circle cx="4" cy="54.5" id="0"></circle>
          <circle cx="7" cy="54.6" id="1"></circle>
          <circle cx="10" cy="96.3" id="2"></circle>
        </svg>
